...
const Home = () => {
  ...
  // Thêm Intersection Observer để theo dõi các phần tử
  useEffect(() => {
    ...
    const observer = new IntersectionObserver(
      ...
      { threshold: 0.1 } // 10% phần tử hiển thị thì kích hoạt
    );
    ...
    <div className="homepage">
      <Container fluid className="pokemon-promo text-center">
        ...
        <div className="fade-in-section">
          ...
          Pokémon Legends: Z-A Releases Late 2025!
          </h1>
        ...
        {/* Phần Lumiose City */}
        <Card className="lumiose-card fade-in-section">
          <Card.Body>
            ...
            <p className="lumiose-description">
              ...
              plan is underway to shape the city into a place that belongs to
              both people and Pokémon. Compared to Lumiose City as it appeared
              in the Pokémon X and Pokémon Y games, released in 2013, more
              greenery now adorns the city, alongside facilities with a
              cutting-edge feel.
            </p>
            <p className="lumiose-description">
            ...
            <p className="story-description">
              While visiting Lumiose City during your travels, you'll come to
              stay in an old hotel named Hotel Z. This hotel will serve as your
              base as you and the new friends you'll meet in Lumiose tackle all
              sorts of incidents that will occur in the city.
            </p>
            <Row className="mt-4 gx-0 gy-2">
        ...
        <Card
          className="pokemon-slide fade-in-section"
          style={{ backgroundColor: "#FEFDF3" }}
        >
        ...
        <Card className="characters-card fade-in-section">
          <Card.Body>
              ...
              <Row className="align-items-center justify-content-center">
                ...
                <Col md={5} className="characters-info">
                  ...
                  <p className="characters-description">
                    ...
                    supporting the owner however they can. They may come on
                    strong at times, but they like helping people and Pokémon.
                    They’re quite skilled at Pokémon battles too.
                  </p>
                  <p>
